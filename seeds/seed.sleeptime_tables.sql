...
VALUES
('dunder', 2, password, password)
('John', 3, john-password, john-password)
('Amy', 1, amy-password, amy-password);

INSERT INTO sleeptime_data(data_created, bed_time, wakeup_time, uder_id)
VALUES
